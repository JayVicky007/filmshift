...
const TMDB_POSTER_BASE_URL = "https://tmdb.org/t/p/w500";
const TMDB_BACKDROP_BASE_URL = "https://tmdb.org/t/p/w1280";
const TMDB_PROFILE_BASE_URL = "https://tmdb.org/t/p/w185";
  ...
  return (
    <main className="min-h-screen bg-background text-foreground pb-12">
      ...
      <section className="relative isolate overflow-hidden border-b border-text-muted/15">
        ...
        <div className="mx-auto flex w-full max-w-7xl min-w-0 flex-col gap-8 px-5 pb-16 pt-8 sm:px-8 md:flex-row md:items-start md:gap-10 md:px-10 md:pt-14 lg:gap-12 lg:px-12">
          ...
          <div className="min-w-0 flex-1">
            ...
            {/* Action Bar Block matching Movie configuration styling layout perfectly */}
            ...
            {/* Critic Scores Section: Reconfigured for Metacritic Parity Checkers */}
            <section className="mt-10">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                <div className="rounded-2xl border border-rose-400/40 bg-rose-500/10 p-4 text-foreground shadow-sm">
                  <p className="text-sm font-semibold text-text-muted">TMDB Average</p>
                  <p className="mt-1 text-2xl font-bold text-foreground">
                    {show.vote_average ? `${(show.vote_average * 10).toFixed(0)}%` : "N/A"}
                  </p>
                </div>
                <div className="rounded-2xl border border-emerald-400/40 bg-emerald-500/10 p-4 text-foreground shadow-sm">
                  ...
                  <p className="mt-1 text-2xl font-bold text-foreground">
                    {/* Fallback cleanly without affecting media that contains meta fields */}
                    {"metascore" in (show.ratings as any) && (show.ratings as any).metascore 
                      ? formatScore((show.ratings as any).metascore) 
                      : "--"}
                  </p>
      ...
      <div className="mx-auto max-w-7xl space-y-14 px-5 py-14 sm:px-8 lg:px-12">
        ...
        {/* ✅ FIXED CREDITS SECTION: Placed gracefully back into the layout stream */}
...
// ✅ FIXED THEATER MODAL COMPONENT: Restored matching explicit layout routing string laws
